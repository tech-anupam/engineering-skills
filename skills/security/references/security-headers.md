...
Recommended Value: `default-src 'self'; script-src 'self'; object-src 'none';`
...
Why it matters: Limits exposure if a site is compromised.
...
## Validation
Test your live site using [SecurityHeaders.com](https://securityheaders.com).

Run this command locally to check headers:
```bash
